...
class AzureVision():
    def __init__(self):
        if 'CUSTOMCONNSTR_COMPUTER_VISION_SUBSCRIPTION_KEY' in os.environ:
            self.subscription_key = os.environ['CUSTOMCONNSTR_COMPUTER_VISION_SUBSCRIPTION_KEY']
        else:
        ...
        if 'CUSTOMCONNSTR_COMPUTER_VISION_ENDPOINT' in os.environ:
            self.endpoint = os.environ['CUSTOMCONNSTR_COMPUTER_VISION_ENDPOINT']
        else:
